...
export default function ChatGPT() {
  ...
  async function handleAsk() {
    ...
    try {
      ...
      setError(
        "Could not reach the ChatGPT backend. Make sure the Python server is running on port 8000."
      );
    }
    setLoading(false);
  }
  ...
  return (
    <div className="page">
      ...
      <textarea
        ...
        rows={4}
        placeholder={
          'e.g. "Write a summary for a software engineer with 3 years of experience"'
        }
      />
