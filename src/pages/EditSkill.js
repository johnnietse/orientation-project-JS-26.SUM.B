...
export default function EditSkill() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSkills(skills.map((i) => (i.id === Number(id) ? { ...i, ...form } : i)));
    }
    setSaved(true);
  ...
  return (
    <div className="page">
      ...
      <form onSubmit={handleSubmit}>
        <label>Name <input name="name" value={form.name} onChange={handleChange} placeholder="e.g. JavaScript, Python" required /></label>
